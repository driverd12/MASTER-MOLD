# MASTER MOLD Claude Instructions

MASTER MOLD is a **local-first MCP server runtime** — the foundation layer for Dan Driver's local agent office. Claude is both an **inbound MCP client** and the designated **safety and critique lane** in the agent council.
