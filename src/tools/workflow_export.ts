  ...
  const stepTemplates = input.steps
    .map((step) => {
      ...
      return {
        ...
        step,
        annotations: {
          "master-mold.io/goal-id": input.goal.goal_id,
          "master-mold.io/plan-id": input.plan.plan_id,
          "master-mold.io/plan-step-id": step.step_id,
          "master-mold.io/step-kind": step.step_kind,
          "master-mold.io/executor-kind": step.executor_kind ?? "",
          "master-mold.io/executor-ref": step.executor_ref ?? "",
          "master-mold.io/isolation-mode": readString(taskExecution.isolation_mode) ?? "",
          "master-mold.io/selected-backend-id": readString(taskExecution.selected_backend_id) ?? "",
          "master-mold.io/selected-host-id": readString(taskExecution.selected_host_id) ?? "",
          "master-mold.io/contract-mode": "suspend",
        },
      };
    });
