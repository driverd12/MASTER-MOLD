import { z } from "zod";
import { Storage, type WorkerFabricHostRecord, type WorkerFabricStateRecord } from "../storage.js";
...
export const workerFabricSchema = z
  .object({
    action: z.enum(["status", "configure", "upsert_host", "remove_host"]).default("status"),
    mutation: mutationSchema.optional(),
    enabled: z.boolean().optional(),
    strategy: z.enum(["balanced", "prefer_local", "prefer_capacity"]).optional(),
